...
namespace HospitalManagement
{
    ...
    public static class StoryboardHelpers
    {
        ...
        public static void AddSlideFromRight( this Storyboard storyboard, float seconds, double offset, float decelerationRation = 0.9f, bool keepMargin = true )
        {
        ...
        public static void AddSlideToRight ( this Storyboard storyboard, float seconds, double offset, float decelerationRation = 0.9f, bool keepMargin = true )
        {
            ...
            var animation = new ThicknessAnimation
            {
                ...
                To = new Thickness( keepMargin ? offset : offset, 0, -offset, 0 ),
                DecelerationRatio = decelerationRation
            };
        ...
        /// <param name="decelerationRation">The rate of deceleration</param>
        /// <param name="keepMargin">Whether to keep the element at the same width during animation</param>
        public static void AddSlideFromLeft ( this Storyboard storyboard, float seconds, double offset, float decelerationRation = 0.9f , bool keepMargin = true)
        {
            // Create the margin animate from right
            var animation = new ThicknessAnimation
            {
                Duration = new Duration( TimeSpan.FromSeconds( seconds ) ),
                From = new Thickness( -offset, 0, keepMargin ? offset : offset, 0 ),
                To = new Thickness( 0 ),
                DecelerationRatio = decelerationRation
            };
